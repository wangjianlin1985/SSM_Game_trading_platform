...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">游戏交易网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=1">动作游戏</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=2">冒险游戏</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=3">格斗游戏</a></li>
                <li><a href="<%=basePath %>Product/frontlist?productClassObj.classId=4">角色扮演</a></li> 
