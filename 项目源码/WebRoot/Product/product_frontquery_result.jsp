...
<%
    ...
    String productName = (String)request.getAttribute("productName"); //游戏名称查询关键字
    String recommandFlag = (String)request.getAttribute("recommandFlag"); //是否推荐查询关键字
    String recipeFlag = (String)request.getAttribute("recipeFlag"); //是否特价查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Product/frontlist">游戏信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Product/product_frontAdd.jsp" style="display:none;">添加游戏</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<productList.size();i++) {
            		...
            		Product product = productList.get(i); //获取到游戏对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getMainPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		游戏类别:<%=product.getProductClassObj().getClassName() %>
			     	</div>
			     	<div class="field">
	            		游戏名称:<%=product.getProductName() %>
			     	</div>
			     	<div class="field">
	            		游戏库存:<%=product.getProductNum() %>
			     	</div>
			     	<div class="field">
	            		游戏价格:<%=product.getPrice() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15">
            ...
            <div class="form-group">
            	<label for="productClassObj_classId">游戏类别：</label>
			...
			<div class="form-group">
				<label for="productName">游戏名称:</label>
				<input type="text" id="productName" name="productName" value="<%=productName %>" class="form-control" placeholder="请输入游戏名称">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="recipeFlag">是否特价:</label>
				<input type="text" id="recipeFlag" name="recipeFlag" value="<%=recipeFlag %>" class="form-control" placeholder="请输入是否特价">
			</div>
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;游戏信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="product_productId_edit" class="col-md-3 text-right">游戏id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="product_productId_edit" name="product.productId" class="form-control" placeholder="请输入游戏id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="product_productClassObj_classId_edit" class="col-md-3 text-right">游戏类别:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productName_edit" class="col-md-3 text-right">游戏名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productName_edit" name="product.productName" class="form-control" placeholder="请输入游戏名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_mainPhoto_edit" class="col-md-3 text-right">游戏图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productNum_edit" class="col-md-3 text-right">游戏库存:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productNum_edit" name="product.productNum" class="form-control" placeholder="请输入游戏库存">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_price_edit" class="col-md-3 text-right">游戏价格:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_price_edit" name="product.price" class="form-control" placeholder="请输入游戏价格">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="product_recipeFlag_edit" class="col-md-3 text-right">是否特价:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_recipeFlag_edit" name="product.recipeFlag" class="form-control" placeholder="请输入是否特价">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_productDesc_edit" class="col-md-3 text-right">游戏描述:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var product_productDesc_edit = UE.getEditor('product_productDesc_edit'); //游戏描述编辑器
