...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Comment/comment_frontAdd.jsp" style="display:none;">添加评论</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>评论id</td><td>被评游戏</td><td>评论内容</td><td>评论时间</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<commentList.size();i++) {
					    	            		...
					    	            		Comment comment = commentList.get(i); //获取到评论对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											...
 											<td>
 												...
 												<a href="#" onclick="commentDelete('<%=comment.getCommentId() %>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="commentQueryForm" id="commentQueryForm" action="<%=basePath %>Comment/userFrontlist" class="mar_t15">
            <div class="form-group">
            	<label for="productObj_productId">被评游戏：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="comment_productObj_productId_edit" class="col-md-3 text-right">被评游戏:</label>
		  	 <div class="col-md-9">
